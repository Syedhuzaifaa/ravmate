  ...
  return (
    <section className="section-container  text-center bg-black">
      <div className="max-w-7xl mx-auto mb-12 reading-section">
        ...
        <p className="section-subtitle my-12 max-w-4xl mx-auto subtitle">
        You're scaling, revenue is growing, but something's breaking.          
          <br /><br />
          Maybe it's your team, maybe it's your process or maybe it's you.
          <br /><br />
          Schedule a call. We'll figure out what's stuck, what needs to change, and whether I'm the right person to help you fix it.
        </p>
      </div>
