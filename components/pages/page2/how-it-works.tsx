    ...
    <section className="section-container">
        ...
        {steps.map((step, idx) => (
          <div key={idx}>
            <div className="flex gap-4 items-start">
              <div className="w-12 h-12 bg-emerald-500 text-black font-bold rounded-full flex items-center justify-center flex-shrink-0 text-lg">
                {step.number}
              </div>
            ...
            {idx < steps.length - 1 && <div className="h-8 border-l-2 border-slate-700 ml-6"></div>}
          </div>
        ))}
      </div>
      ...
      <div className="mt-12 text-center">
        <p className="text-slate-400 max-w-2xl mx-auto mb-8">
          Most engagements are long-term. Real change doesn't happen in 30 days. We build it with you, and actually live
          it with you.
        </p>
